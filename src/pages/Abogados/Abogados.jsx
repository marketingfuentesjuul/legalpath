      ...
      <main className="pt-14">
        ...
        <section id="por-que-legalpath" className="max-w-7xl mx-auto px-8 py-20 space-y-12">
          ...
          >
            ...
            {/* Temporarily hidden: Card 3: Green (Gestión Todo en Uno)
        ...
        <section id="como-empezar" className="max-w-7xl mx-auto px-8 py-20 space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8 text-center lg:text-left">
              ...
              <h3 className="text-xl sm:text-2xl md:text-[30.7px] font-extrabold tracking-tight text-on-background">Elige tu caso y envía tu propuesta</h3>
              <p className="text-base md:text-xl text-secondary leading-relaxed max-w-lg mx-auto lg:mx-0 text-justify lg:text-left">
                Según tu especialidad buscas dentro del marketplace los casos que más te interesen y usas un token para enviar tu propuesta.
              </p>
            </div>
            {/* Mockup: Marketplace & Sending Proposal */}
            <div className="relative bg-slate-900 rounded-3xl p-8 text-white overflow-hidden min-h-[420px] flex items-center justify-center border border-slate-800 shadow-2xl">
              <div className="space-y-4 w-full max-w-md">
                <div className="flex items-center justify-between bg-white/5 p-3.5 rounded-2xl border border-white/10">
                  <div className="flex items-center gap-2.5">
                    <span className="material-symbols-outlined text-[#EE6C4D]">search</span>
                    <span className="text-xs font-bold tracking-wide">Marketplace de Casos</span>
                  </div>
                  <span className="text-[10px] bg-[#EE6C4D]/20 text-[#EE6C4D] font-bold px-2.5 py-1 rounded-full border border-[#EE6C4D]/30">Filtro: Tu especialidad</span>
                </div>

                <div className="bg-white/10 p-4 rounded-2xl border border-white/10 space-y-2">
                  <div className="flex items-center justify-between">
                    <span className="text-[9px] bg-blue-500/20 text-blue-300 font-bold px-2 py-0.5 rounded-full border border-blue-400/20">Derecho Civil</span>
                    <span className="text-[9px] text-slate-400">Pre-calificado ✨</span>
                  </div>
                  <h4 className="text-xs font-bold text-white">Incumplimiento de contrato de arriendo</h4>
                  <p className="text-[10px] text-slate-300 leading-relaxed">Arrendatario con deuda de 4 meses. Requiere inicio de acciones legales para desalojo y cobro de morosidad.</p>
                </div>

                <div className="bg-white/5 p-4 rounded-2xl border border-white/10 space-y-3">
                  <div className="flex items-center justify-between text-[11px] font-semibold text-slate-300">
                    <span>Tu propuesta de honorarios y estrategia</span>
                    <span className="text-[#EE6C4D] text-[10px] font-bold flex items-center gap-1">
                      <span className="material-symbols-outlined text-[13px]">toll</span> 1 Token
                    </span>
                  </div>
                  <div className="bg-black/30 p-2.5 rounded-xl text-[10px] text-slate-300 border border-white/5 italic">
                    "Hola, cuento con amplia experiencia en juicios de arrendamiento..."
                  </div>
                  <button className="w-full py-3 bg-[#EE6C4D] text-white font-bold rounded-xl text-xs shadow-lg hover:bg-[#EE6C4D]/90 transition-all flex items-center justify-center gap-2">
                    <span className="material-symbols-outlined text-sm">send</span>
                    <span>Enviar propuesta (1 Token)</span>
                  </button>
                </div>
              </div>
            </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="lg:order-2 space-y-8 lg:pl-16 text-center lg:text-left">
              <div className="text-[100px] sm:text-[120px] font-extrabold leading-none font-headline" style={{ color: '#EE6C4D', opacity: 0.15 }}>04</div>
              <h3 className="text-xl sm:text-2xl md:text-[30.7px] font-extrabold tracking-tight text-on-background">El cliente acepta tu propuesta</h3>
              <p className="text-base md:text-xl text-secondary leading-relaxed max-w-lg mx-auto lg:mx-0 text-justify lg:text-left">
                Aquí es cuando el cliente, después de haber recibido varias propuestas y haber evaluado las opciones, te elige a ti y desbloqueas sus datos de contacto directos para iniciar la atención.
              </p>
            </div>
            {/* Mockup: Proposal Accepted & Unlocked Contact */}
            <div className="lg:order-1 relative bg-slate-900 rounded-3xl p-8 text-white overflow-hidden min-h-[420px] flex items-center justify-center border border-slate-800 shadow-2xl">
              <div className="space-y-4 w-full max-w-md">
                <div className="bg-emerald-500/15 border border-emerald-500/30 p-3.5 rounded-2xl flex items-center gap-3">
                  <div className="w-9 h-9 rounded-full bg-emerald-500 flex items-center justify-center shrink-0">
                    <span className="material-symbols-outlined text-white text-lg">check</span>
                  </div>
                  <div>
                    <div className="text-xs font-bold text-emerald-400">¡Propuesta Aceptada por el Cliente!</div>
                    <div className="text-[10px] text-emerald-200/80">Has sido seleccionado entre las propuestas recibidas.</div>
                  </div>
                </div>
                ...
                <div className="bg-white/10 p-5 rounded-2xl border border-white/10 space-y-4">
                  <div className="flex items-center justify-between border-b border-white/10 pb-3">
                    <div className="flex items-center gap-3">
                      <div className="w-10 h-10 rounded-full bg-[#EE6C4D]/20 text-[#EE6C4D] flex items-center justify-center font-bold text-sm">
                        CS
                      </div>
                      <div>
                        <h4 className="text-xs font-bold text-white">Carlos Silva M.</h4>
                        <p className="text-[10px] text-slate-400">Cliente verificado · Caso #4092</p>
                      </div>
                    </div>
                    <span className="text-[9px] bg-emerald-500/20 text-emerald-300 font-bold px-2 py-0.5 rounded-full border border-emerald-500/30">Datos Desbloqueados</span>
                  </div>

                  <div className="space-y-2 text-xs">
                    <div className="flex items-center justify-between p-2.5 bg-black/30 rounded-xl border border-white/5">
                      <span className="text-[10px] text-slate-400 flex items-center gap-1.5">
                        <span className="material-symbols-outlined text-sm text-emerald-400">phone</span> Teléfono / WhatsApp
                      </span>
                      <span className="font-mono font-bold text-white text-[11px]">+56 9 8765 4321</span>
                    </div>
                    <div className="flex items-center justify-between p-2.5 bg-black/30 rounded-xl border border-white/5">
                      <span className="text-[10px] text-slate-400 flex items-center gap-1.5">
                        <span className="material-symbols-outlined text-sm text-blue-400">mail</span> Correo Electrónico
                      </span>
                      <span className="font-mono font-bold text-white text-[11px]">carlos.silva@email.com</span>
                    </div>
                  </div>
                </div>

                <div className="flex gap-2">
                  <button className="flex-1 py-3 bg-emerald-600 hover:bg-emerald-500 text-white font-bold rounded-xl text-xs transition-colors flex items-center justify-center gap-1.5 shadow-md">
