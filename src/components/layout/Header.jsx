    ...
    <header className={`fixed top-0 w-full z-50 transition-all duration-500 flex justify-center ${scrolled ? 'pt-2' : 'pt-[15px]'}`}>
      <div className={`w-full transition-all duration-500 mx-2 sm:mx-4 ${
        ...
        <div className="flex items-center gap-1.5 sm:gap-2 lg:gap-3 xl:gap-4 shrink-0">
          {isPublicarCaso ? (
            <Link to="/auth/login-cliente" className="bg-[#EE6C4D] text-white px-4 py-2 sm:px-6 sm:py-2.5 rounded-full text-xs lg:text-sm font-bold shadow-lg hover:scale-95 active:scale-90 transition-transform text-center inline-block whitespace-nowrap">
            ...
            <>
              ...
              <Link to="/auth/login-abogado" className="bg-[#EE6C4D] text-white px-2 py-1.5 sm:px-2.5 sm:py-1.5 lg:px-5 lg:py-2 xl:px-6 xl:py-2.5 rounded-full text-xs lg:text-sm font-bold shadow-lg hover:scale-95 active:scale-90 transition-transform text-center inline-block whitespace-nowrap">
                Iniciar sesión
              </Link>
            </>
          ) : (
            <>
              <Link to="/auth/login-cliente" className="mint-gradient text-white px-2 py-1.5 sm:px-3 sm:py-1.5 lg:px-5 lg:py-2 xl:px-6 xl:py-2.5 rounded-full text-xs lg:text-sm font-bold shadow-lg hover:scale-95 active:scale-90 transition-transform text-center inline-block whitespace-nowrap">
                <span className="hidden sm:inline">Ingresar a mi cuenta</span>
                <span className="sm:hidden">Ingresar</span>
              </Link>
