...
export default function ClientsManagement() {
  ...
  const handleExecuteModeration = async () => {
    ...
    try {
      ...
      setAlertModal({
        show: true,
        title: action === 'suspend' ? 'Cliente suspendido' : action === 'ban' ? 'Cliente baneado' : 'Cliente reactivado',
        message: `El cliente ha sido ${action === 'suspend' ? 'suspendido' : action === 'ban' ? 'baneado' : 'reactivado'} con éxito.`,
        type: 'success'
      });
