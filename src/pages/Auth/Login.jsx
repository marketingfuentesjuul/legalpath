        ...
        <div className="bg-white rounded-[2rem] p-8 sm:p-10 shadow-[0_15px_50px_-10px_rgba(238,108,77,0.1)] border border-slate-100">
          ...
          <div className="space-y-3 mb-6">
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 border border-slate-300 rounded-xl px-4 py-3 bg-white hover:bg-slate-50 transition-colors shadow-sm font-semibold text-[14px] text-slate-700"
            >
            ...
            <button 
              ...
              className="w-full flex items-center justify-center gap-3 border-[#1877F2] rounded-xl px-4 py-3 bg-[#1877F2] hover:bg-[#166FE5] transition-colors shadow-sm font-semibold text-[14px] text-white"
            >
          ...
          {error && (
            <div className="mb-6 p-4 bg-red-50 border border-red-200 text-red-600 text-[13px] rounded-xl flex items-center gap-2">
