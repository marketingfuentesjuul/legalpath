...
const Home = () => {
  ...
  const faqs = [
    ...
    { q: "¿Mi información es confidencial?", a: "Sí, es 100% confidencial. Tu caso es publicado de forma anónima y solo los abogados registrados en nuestra plataforma pueden ver los detalles. Tu identidad <strong>jamás es revelada hasta que tú aceptes una propuesta de algún abogado</strong>." },
    ...
    <>
      ...
      <main className="pt-14">
        ...
        <motion.section 
          ...
          className="relative min-h-[85vh] flex items-center justify-center overflow-hidden px-6 md:px-12 pt-2 md:pt-16 pb-20 md:pb-28"
        >
        ...
        <section id="faq" className="max-w-7xl mx-auto px-6 md:px-8 py-24 border-t border-slate-100/60">
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-16 items-start">
            ...
            <div className="lg:col-span-5 space-y-6 lg:sticky lg:top-28 text-center lg:text-left">
              ...
              <p className="text-base md:text-lg text-secondary leading-relaxed max-w-sm mx-auto lg:mx-0 text-justify lg:text-left">
