              ...
              <div className="space-y-8 max-w-2xl mx-auto">
                ...
                <div className="space-y-6">
                  ...
                  <div className="flex justify-center">
                    <button type="button" className="social-btn w-full flex items-center justify-center gap-3 py-3.5 px-6 bg-white border-[1.5px] border-slate-200 rounded-2xl font-semibold text-[15px] text-on-background hover:bg-slate-50">
