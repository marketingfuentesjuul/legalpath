...
const FaqItem = ({ question, answer, isOpen, onClick }) => {
  // Safe rendering of simple HTML (only <strong> supported)
...
const Home = () => {
  ...
  useEffect(() => {
    let i = 0
    let timeoutId
    // Original typing animation logic
    ...
    <>
      <section className="relative min-h-[90vh] flex flex-col items-center justify-center overflow-hidden px-8 py-20">
        ...
        <div className="max-w-4xl w-full text-center space-y-10 relative z-10">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <a href="#como-funciona" className="bg-white text-on-secondary-container border border-slate-200 px-10 py-5 rounded-full text-xl font-bold hover:bg-slate-50 transition-colors shadow-sm text-center">
              ¿Cómo funciona?
            </a>
          </div>
      ...
      <section id="como-funciona" className="max-w-7xl mx-auto px-8 py-20 space-y-32">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="text-[120px] font-extrabold leading-none text-primary-container/20 dark:text-primary-container/30 font-headline" style={{color: '#1ECCA7', opacity: 0.15}}>01</div>
          ...
          <div className="relative rounded-2xl overflow-hidden shadow-[0_40px_80px_-20px_rgba(0,107,86,0.18)] border border-slate-200/60 bg-[#f8fafc] min-h-[440px]">
            ...
            <div className="p-6 space-y-5">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 mt-1">Mientras más detalles nos des, mejores propuestas recibirás. Si quieres, puedes agregarle imágenes, pantallazos, correos, contratos o cualquier documento relevante.</p>
              </div>
              <div className="bg-white rounded-xl border border-slate-200 p-4 min-h-[110px] relative shadow-sm">
                <div className="text-sm text-slate-600 leading-relaxed">
                  <span className="mockup-typing" ref={typingRef}></span>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="lg:order-2 space-y-8">
            <div className="text-[120px] font-extrabold leading-none text-primary-container/20 dark:text-primary-container/30 font-headline" style={{color: '#1ECCA7', opacity: 0.15}}>02</div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="text-[120px] font-extrabold leading-none text-primary-container/20 dark:text-primary-container/30 font-headline" style={{color: '#1ECCA7', opacity: 0.15}}>03</div>
      ...
      <section id="por-que-legalpath" className="max-w-7xl mx-auto px-8 py-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 h-auto md:h-[600px]">
          <div className="md:col-span-2 bg-white rounded-xl p-10 flex flex-col justify-between shadow-sm border border-slate-50 relative overflow-hidden group hover:scale-[1.02] transition-all duration-300 cursor-default">
            <div className="relative z-10 space-y-4">
              <div className="w-14 h-14 bg-primary-container/10 rounded-2xl flex items-center justify-center text-primary-container group-hover:scale-110 transition-transform duration-300">
            ...
            <div className="absolute right-0 bottom-0 translate-y-12 translate-x-12 opacity-10 group-hover:scale-110 group-hover:-translate-x-8 group-hover:-translate-y-8 transition-all duration-700">
              <span className="material-symbols-outlined text-[20rem]" style={{fontVariationSettings: '"FILL" 1'}}>shield</span>
            </div>
          </div>
          <div className="bg-surface-container-low rounded-xl p-8 flex flex-col items-center text-center justify-center shadow-sm border border-slate-100 space-y-6 hover:scale-[1.02] transition-all duration-300 group cursor-default">
            <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center text-primary-container shadow-inner group-hover:scale-110 transition-transform duration-300">
          ...
          <div className="bg-primary-container text-on-primary-container rounded-xl p-8 flex flex-col justify-end shadow-lg relative overflow-hidden hover:scale-[1.02] transition-all duration-300 group cursor-default">
            <div className="absolute top-4 right-4 opacity-20 group-hover:scale-125 group-hover:-rotate-12 transition-transform duration-500">
          ...
          <div className="bg-on-background text-white rounded-xl p-8 flex flex-col justify-end shadow-lg relative overflow-hidden md:col-span-2 hover:scale-[1.02] transition-all duration-300 group cursor-default">
            <div className="flex items-center gap-8">
              ...
              <div className="hidden lg:flex gap-2 group-hover:translate-x-2 transition-transform duration-500">
